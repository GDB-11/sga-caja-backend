 ...
 * de dominio). Resuelve {@code ReceiptId}/{@code IncomeCategoryId} a partir de los {@code Uuid}
 * del modelo de dominio vía los {@code JpaRepository} de esos módulos (dependencia
...
public class IncomeMapper {
    ...
    public IncomeMapper(ReceiptJpaRepository receiptJpaRepository, IncomeCategoryJpaRepository incomeCategoryJpaRepository) {
        this.receiptJpaRepository = receiptJpaRepository;
        this.incomeCategoryJpaRepository = incomeCategoryJpaRepository;
    }

    public IncomeEntity toNewEntity(Receipt receipt, String depositorName, IncomeCategory incomeCategory, String concept, BigDecimal amount) {
